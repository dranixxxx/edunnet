...
import { HorizontalBar, Line, Pie, Doughnut, Bar, Radar, Polar } from 'react-chartjs-2';
...
const newData = (moreData = {}, moreData2 = {}) => {
  return {
    labels: PATHS,
    type:'horizontalBar',
  ...
  return (
    <Page title="Charts" breadcrumbs={[{ name: 'Charts', active: true }]}>
      <Row>
        ...
        <Col xl={6} lg={12} md={12}>
          <Card>
            <CardHeader>Bar1</CardHeader>
            <CardBody>
              <HorizontalBar data={newData()} />
            </CardBody>
          </Card>
        </Col>
